package com.ajibsbaba.cameraxdemo
...
import com.ajibsbaba.cameraxdemo.databinding.ActivityMainBinding
    ...
    private fun captureVideo() {
        ...
        val contentValues =
            ContentValues().apply {
                ...
                if (Build.VERSION.SDK_INT > Build.VERSION_CODES.P) {
                    put(MediaStore.Video.Media.RELATIVE_PATH, "Movies/CameraXDemo-Video")
                }
            }
